                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-md-right">
                                <button onclick="window.print()" class="float-lg-left mb-lg-0 mb-3  btn btn-warning btn-icon icon-left"><i
                                        class="fa fa-print"></i> Print</button>
                                <div class="mb-lg-0 mb-3">
                                    <a href="javascript:;" class="btn btn-info btn-icon icon-left" data-toggle="modal"
                                         data-id="{{ $data['order']->invoice_number.'/mail' }}"><i
                                            class="fa fa-mail"></i>
