            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="categories__item categories__large__item set-bg"
                        data-setbg="{{ asset('me') }}/img/bg-slider.jpg">
                        <div class="categories__text">
                            <p>Beragam Merchandise Busana Muslim Pria Mulai Dari Gamis, Setelan Koko, Celana dan Kopiah Semuanya Tersedia Di Fadhil Muslim
                                Store.</p>
